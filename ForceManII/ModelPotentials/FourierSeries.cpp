                            ...
                            const CoordInput_t &in_coords)const
{
    ...
    const Vector &Qs=in_coords[0],&Vs=in_params.at(Param_t::amp),
                 &phis=in_params.at(Param_t::phi),&ns=in_params.at(Param_t::n);
